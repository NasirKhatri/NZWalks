...
namespace NZWalks.API.Data
{
    public class NZWalksDBContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var duifficulties = new List<Difficulty>()
            {
                new Difficulty { Id = Guid.Parse("2c5c3f46-baed-449e-8403-c17583586cd6"), Name = "Easy"},
                new Difficulty { Id = Guid.Parse("f3bbeeb8-0a25-4ab1-9fc6-a88c157720e4"), Name = "Medium"},
                new Difficulty { Id = Guid.Parse("c33461bd-1f86-4fec-a5be-839cf097c584"), Name = "Hard"}
            };

            modelBuilder.Entity<Difficulty>().HasData(duifficulties);
